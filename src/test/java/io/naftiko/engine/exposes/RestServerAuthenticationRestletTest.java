...
import io.naftiko.engine.exposes.rest.RestServerAuthenticationRestlet;
...
public class RestServerAuthenticationRestletTest {
    ...
    public void bearerShouldAuthorizeMatchingToken() {
        HttpBearerAuthenticationSpec auth = new HttpBearerAuthenticationSpec();
    ...
    public void apiKeyHeaderShouldAuthorizeMatchingValue() {
        HttpApiKeyAuthenticationSpec auth = new HttpApiKeyAuthenticationSpec();
