---
name: compose-apis-reference
description: >
  “Compose APIs” reference: use this when the user wants to compose multiple
...
A “compose-apis” exposed operation uses orchestrated mode:
